<template>
	...
	<button @click="move(-1)" type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block"><<</button>
	<input class="w-3/5" type="range" :min="0" :max="imageData.length - 1" step="1" v-bind:value="currentIndex"
